...
async function swap2(){
    allowance=mycontract1.methods.allowance(accounts[0],"0x46A0157096D497483c0773FAe88ea0AF3EC857f9").call()
    if (!allowance>=web3.utils.toBN($(".wtt2").val()*10**18).toString()){
        await mycontract1.methods.approve("0x46A0157096D497483c0773FAe88ea0AF3EC857f9",web3.utils.toBN($(".wtt2").val()*10**19).toString()).send({from:accounts[0]})
    }
